...
class SessionReport(models.TransientModel):
    ...
    _description = 'Generar informe de tabla de tiempo'

    state = fields.Selection(
        [('faculty', 'Faculty'), ('student', 'Estudiante')],
    ...
    def gen_time_table_report(self):
        ...
        if data['state'] == 'student':
            ...
            return self.env.ref(
                'crmjj_calendario.report_student_timetable_generate') \
            ...
            return self.env.ref(
                'crmjj_calendario.report_teacher_timetable_generate') \
                .report_action(self, data=data)
