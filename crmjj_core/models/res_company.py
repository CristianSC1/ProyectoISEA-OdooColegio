...
class ResCompany(models.Model):
    ...
    accreditation = fields.Text('Acreditacion')
    approval_authority = fields.Text('Autoridad de aprobación')


class ResUsers(models.Model):
    _inherit = "res.users"

    user_line = fields.One2many('op.student', 'user_id', 'Linea de usuario')
    child_ids = fields.Many2many(
        'res.users', 'res_user_first_rel1',
        'user_id', 'res_user_second_rel1', string='Niños')
